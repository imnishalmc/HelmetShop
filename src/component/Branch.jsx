...
const Branch = (theme, setTheme) => {
  return (
    <div id='branches' className='  flex flex-col   items-center justify-center gap-6 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
...
<img src={theme=='dark' ? assets.Whitelogo : assets.Blacklogo} alt="" className='w-30 h-30 rounded-full' />
<div>
