...
const ServiceProvider = ({title,description,icon}) => {
    return (
        <div className='relative overflow-hidden max-w-lg m-2 sm:m-10 border border-gray-200 rounded-3xl dark:border-gray-700 transform-none h-50 bg-gray-200 '>
            <div className='flex items-center gap-8 p-9  transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
