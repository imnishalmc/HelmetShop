...
const HeroSection = () => {
    return (
        ...
        <div className='flex flex-col items-center gap-5 py-17 px-4 sm:px-12 lg:px-24 xl:px-40 text-center overflow-hidden w-full  text-grey-700 dark:text-white' >
            ...
            <h1 className='  text-4xl  font-medium  max-w-5xl sm:text-[43px] xl:text-[70px] sm:px-12 lg:px-24 xl:px-40 text-center'> <span className= 'bg-gradient-to-r from-[#1c22bc] to-[#4D8AEA] bg-clip-text text-transparent '>Uncompromised</span> Protection For The Fearless Rider</h1>
